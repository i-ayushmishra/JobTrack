...
const SearchBar = (props) => {
  ...
  return (
    ...
    <div className="flex flex-col sm:flex-row flex-wrap gap-4 my-10 
                justify-center items-center px-4 sm:px-6 md:px-10">

      <select
        onChange={handleChange}
        name="title"
        value={jobCriteria.title}
        className="w-full sm:w-64 py-3 px-4 bg-zinc-200 font-semibold rounded-md"
      >
      ...
      <button
        onClick={search}
        className="w-full sm:w-64 bg-blue-500 hover:bg-blue-600 
